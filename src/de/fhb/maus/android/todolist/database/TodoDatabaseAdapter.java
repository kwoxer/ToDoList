...
public class TodoDatabaseAdapter {
	...
	public static final String KEY_CONTACTID = "contact";
	...
	public long createTodo(String date, String category, boolean done,
			String summary, String description, String contact) {
	...
	public boolean updateTodo(long rowId, String date, String category,
			boolean done, String summary, String description, String contact) {
	...
	public Cursor fetchAllTodos() {
		return mDatabase.query(DATABASE_TABLE, new String[]{KEY_ROWID,
				...
				KEY_DESCRIPTION, KEY_CONTACTID}, null, null, null, null, null);
	}
	public Cursor fetchAllTodosOrderByName() {
		return mDatabase.query(DATABASE_TABLE, new String[]{KEY_ROWID,
				KEY_DATE, KEY_CATEGORY, KEY_DONE, KEY_SUMMARY,
				KEY_DESCRIPTION, KEY_CONTACTID}, null, null, null, null, KEY_SUMMARY);
	}
	public Cursor fetchAllTodosOrderByDate() {
		return mDatabase.query(DATABASE_TABLE, new String[]{KEY_ROWID,
				KEY_DATE, KEY_CATEGORY, KEY_DONE, KEY_SUMMARY,
				KEY_DESCRIPTION, KEY_CONTACTID}, null, null, null, null, KEY_DATE);
	}
	...
	public Cursor fetchTodo(long rowId) throws SQLException {
		Cursor mCursor = mDatabase.query(true, DATABASE_TABLE, new String[]{
				...
				KEY_DESCRIPTION,KEY_CONTACTID}, KEY_ROWID + "=" + rowId, null, null, null,
				null, null);
		if (mCursor != null) {
			mCursor.moveToFirst();
		}
	...
	private ContentValues createContentValues(String date, String category,
		...
		values.put(KEY_CONTACTID, contact);
		return values;
	}
